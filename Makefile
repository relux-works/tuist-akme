...
ifneq ($(strip $(CORE_ROOT)),)
ifndef TUIST_CORE_ROOT
TUIST_CORE_ROOT := $(CORE_ROOT)
endif
export TUIST_CORE_ROOT
endif

ifneq ($(strip $(SHARED_ROOT)),)
ifndef TUIST_SHARED_ROOT
TUIST_SHARED_ROOT := $(SHARED_ROOT)
endif
export TUIST_SHARED_ROOT
endif
